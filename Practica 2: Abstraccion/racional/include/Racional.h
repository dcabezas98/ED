...
/**
  ...
  * @param r racional a restar al objeto implicito
  */
  Racional operator-(const Racional &r);

/**
  * @brief Sobrecarga del operador -=
  * @param r racional a restar al objeto implícito
  */ 
  void operator-=(const Racional &r);

/**
  * @brief Multiplica dos racionales
  * @param r racional a multiplicar con objeto implicito
  */
  Racional operator*(const Racional &r);
  
/**
  * @brief Sobrecarga del operador *=
  * @param r racional a multiplicar con el objeto implícito
  */ 
  void operator*=(const Racional &r);

  /**
  * @brief Divide dos racionales
  * @param r racional a dividir con objeto implicito
  */
  Racional operator/(const Racional &r);
...
/**
  * @brief Devuelve el valor real de la fracción
  */
  double real();
